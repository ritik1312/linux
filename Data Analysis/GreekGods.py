...
goddess_df = pd.read_csv("greek_goddesses.csv")
goddess_df.head()
...
join_df = pd.merge(gods_df, goddess_df, on='Domain', suffixes=('_god','_goddess'))
avg_age_by_domain = join_df.groupby("Domain")[["Age_god","Age_goddess"]].mean()
avg_age_by_domain
